...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="TextBox1" ErrorMessage="You need a Refill ID"></asp:RequiredFieldValidator>
    <table class="w-100">
        <tr>
            <td>
                ...
                <asp:RequiredFieldValidator ID="RFV2" runat="server" ControlToValidate="TextBox2" ErrorMessage="You need an RX Number"></asp:RequiredFieldValidator>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
